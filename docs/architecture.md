...
This architecture simulates a real-world SaaS system where a stateless Laravel API serves a separate React SPA.
...
Frontend (React SPA) -> Nginx -> Laravel API -> Services -> Database / Redis

Layer responsibilities:
- `Frontend (React SPA)`: renders UI, handles user interaction, and calls backend APIs.
