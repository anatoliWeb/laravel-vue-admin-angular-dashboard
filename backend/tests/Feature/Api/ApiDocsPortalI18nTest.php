...
class ApiDocsPortalI18nTest extends TestCase
{
    ...
    public function test_portal_renders_ukrainian_labels_for_uk_locale_header(): void
    {
    ...
    public function test_portal_renders_german_labels_for_de_locale_header(): void
    {
