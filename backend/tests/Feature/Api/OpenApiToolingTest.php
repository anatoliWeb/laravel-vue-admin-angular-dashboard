...
class OpenApiToolingTest extends TestCase
{
    ...
    public function test_scramble_openapi_tooling_foundation(): void
    {
        ...
        $this->assertSame('Laravel React/Vue/Angular SaaS API', config('scramble.ui.title'));
        ...
        $this->assertSame('Laravel React/Vue/Angular SaaS API', data_get($spec, 'info.title'));
