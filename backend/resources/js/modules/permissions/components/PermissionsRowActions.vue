<template>
  <BaseDropdown>
    <template #trigger="{ isOpen }">
      <button type="button" class="permission-actions-trigger" :class="{ 'is-open': isOpen }">Actions</button>
    </template>

    <template #default="{ close }">
      <div class="permission-actions-panel">
        <button type="button" class="permission-actions-panel__item" @click="onAction('view', close)">View</button>
        <button v-if="canEdit" type="button" class="permission-actions-panel__item" @click="onAction('edit', close)">Edit</button>
        <button v-if="canAssign" type="button" class="permission-actions-panel__item" @click="onAction('assign', close)">Assign to role</button>
      </div>
    </template>
  </BaseDropdown>
</template>
