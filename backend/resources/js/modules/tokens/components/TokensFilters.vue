<template>
  <section class="tokens-filters c-card">
    <div class="tokens-filters__search">
      <label for="tokens-search" class="tokens-filters__label">Search</label>
      <div class="tokens-filters__search-box">
        ...
        <input id="tokens-search" :value="search" type="text" class="tokens-filters__input" placeholder="Search by token name or owner" @input="onSearchInput" />
      </div>
    </div>

    <div class="tokens-filters__group">
      <label class="tokens-filters__label">Owner</label>
      <BaseDropdown>
    ...
    <div class="tokens-filters__group">
      <label class="tokens-filters__label">Status</label>
      <BaseDropdown>
        <template #trigger="{ isOpen }">
    ...
    <div class="tokens-filters__group">
      <label class="tokens-filters__label">Recent use</label>
      <BaseDropdown>
        <template #trigger="{ isOpen }">
    ...
    <div class="tokens-filters__group">
      <label class="tokens-filters__label">Type</label>
      <BaseDropdown>
        <template #trigger="{ isOpen }">
...
const ownerLabel = computed(() => ownerOptions.value.find((item) => item.value === props.owner)?.label ?? 'All owners');
const statusLabel = computed(() => statusOptions.find((item) => item.value === props.status)?.label ?? 'All statuses');
const recentLabel = computed(() => recentOptions.find((item) => item.value === props.recent)?.label ?? 'All activity');
